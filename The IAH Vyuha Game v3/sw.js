const CACHE='iah-vyuha-v1-3';
const ASSETS=['./','./index.html','./game.js','./manifest.json','./README.md','./GENIE3_SCENE_BRIEF.md','./COMMERCIAL_READINESS.md','./LICENSE-THIRD-PARTY.md'];
